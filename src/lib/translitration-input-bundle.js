				...
				s = (function() {
					...
					return (
						(t.prototype.renderInitial = function() {
							(this.suggestionInputBox = document.createElement(
								"input"
							)),
								(this.suggestionWrapper = document.createElement(
									"div"
								)),
								(this.suggestionsList = document.createElement(
									"div"
								)),
								...
								(this.suggestionsList.className =
									"suggestion-list"),
								(this.loadingBox = document.createElement(
									"div"
								)),
